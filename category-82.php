        ...
        <div class="container d-flex flex-column align-items-center h-100 pt-4 pt-lg-5 hero-content">
            ...
            <div class="alphabetical-letters">
                <div class="input-group input-group-lg mb-3">
                    <input type="text" class="form-control rounded-right" id="filterInput" placeholder="أدخل إسم المرض أو الحالة الطبية..." aria-label="أدخل إسم المرض أو الحالة الطبية" aria-describedby="basic-case">
                ...
                <p class="text-primary fs-5 mb-3">ابحث عن اسم المرض</p>
